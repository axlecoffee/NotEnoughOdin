...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.render.drawDynamicTexture
...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.ui.OdinGuiButton
...
object OdinUpdater : GuiScreen() {
    ...
    override fun actionPerformed(button: GuiButton?) {
        when (button?.id) {
            0 -> Minecraft.getMinecraft().displayGuiScreen(null) // Close or Later
    ...
    private fun performUpdate() {
        Runtime.getRuntime().addShutdownHook(Thread {
            ...
            val destinationPath = "${Minecraft.getMinecraft().mcDataDir}/mods/$newJarName".replace('/', File.separatorChar)
    ...
    private val centerX: Int get() = Minecraft.getMinecraft().displayWidth / 2
    private val centerY: Int get() = Minecraft.getMinecraft().displayHeight / 2
