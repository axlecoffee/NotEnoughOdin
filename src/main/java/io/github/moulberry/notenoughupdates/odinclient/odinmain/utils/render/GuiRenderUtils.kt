...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.div
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.minus
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.plus
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.render.RenderUtils.drawTexturedModalRect
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.render.TextAlign.Left
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.times
...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.ui.shader.CircleShader
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.ui.shader.DropShadowShader
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.ui.shader.HSBBoxShader
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.ui.shader.RoundedRectangleShader
...
val scaleFactor get() = ScaledResolution(Minecraft.getMinecraft()).scaleFactor.toFloat()
...
fun getMCTextWidth(text: String) = Minecraft.getMinecraft().fontRendererObj.getStringWidth(text)

fun getTextWidth(text: String, size: Float) = OdinFont.getTextWidth(text, size)

fun getMCTextHeight() = Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT
