...
fun getBlockAt(pos: BlockPos): Block =
    Minecraft.getMinecraft().theWorld?.chunkProvider?.provideChunk(pos.x shr 4, pos.z shr 4)?.getBlock(pos) ?: Blocks.air
...
fun getBlockStateAt(pos: BlockPos): IBlockState =
    Minecraft.getMinecraft().theWorld?.chunkProvider?.provideChunk(pos.x shr 4, pos.z shr 4)?.getBlockState(pos) ?: Blocks.air.defaultState
