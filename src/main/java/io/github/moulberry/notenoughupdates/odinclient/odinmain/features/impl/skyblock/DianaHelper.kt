...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.findNearestGrassBlock
...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.skyblock.DianaBurrowEstimate.activeBurrows
...
object DianaHelper : Module(
    ...
    private inline val hasSpade: Boolean
        get() = Minecraft.getMinecraft().thePlayer?.inventory?.mainInventory?.find { it.skyblockID == "ANCESTRAL_SPADE" } != null
    ...
    fun onRenderWorld(event: RenderWorldLastEvent) {
        ...
        renderPos?.let { guess ->
            val distance = Minecraft.getMinecraft().thePlayer.positionVector.distanceTo(guess)
