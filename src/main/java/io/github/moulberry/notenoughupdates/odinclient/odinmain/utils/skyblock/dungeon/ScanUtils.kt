...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.skyblock.dungeon.tiles.*
...
object ScanUtils {
    ...
    fun onTick(event: ClientTickEvent) {
        if (event.phase != TickEvent.Phase.END || Minecraft.getMinecraft().theWorld == null || Minecraft.getMinecraft().thePlayer == null) return
    ...
    fun getCore(vec2: Vec2): Int {
        ...
        val chunk = Minecraft.getMinecraft().theWorld?.getChunkFromChunkCoords(vec2.x shr 4, vec2.z shr 4) ?: return 0
