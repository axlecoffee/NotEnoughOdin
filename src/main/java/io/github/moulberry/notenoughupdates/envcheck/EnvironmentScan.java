...
public class EnvironmentScan {
		...
		static boolean shouldCheckOnce = false;

		public static void checkEnvironmentOnce() {
			System.out.println("[AXLE] Checking environment for NotEnoughUpdates...");
		...
		static void checkForgeEnvironment() {
			System.out.println("[AXLE] Checking Forge environment for NotEnoughUpdates...");
