...
public class CrystalMetalDetectorSolver {
	...
	private static boolean locateMinesCenterIfNeeded() {
		...
		List<EntityArmorStand> keeperEntities = Minecraft.getMinecraft().theWorld.getEntities(EntityArmorStand.class, (entity) -> {
	...
	private static Vec3Comparable getPlayerPosAdjustedForEyeHeight() {
		return new Vec3Comparable(
			...
			Minecraft.getMinecraft().thePlayer.posY + (Minecraft.getMinecraft().thePlayer.getEyeHeight() - Minecraft.getMinecraft().thePlayer.getDefaultEyeHeight()),
	...
	static boolean isAllowedBlockType(BlockPos pos) {
		return Minecraft.getMinecraft().theWorld.getBlockState(pos).getBlock().getRegistryName().equals("minecraft:gold_block") ||
			Minecraft.getMinecraft().theWorld.getBlockState(pos).getBlock().getRegistryName().equals("minecraft:prismarine") ||
			Minecraft.getMinecraft().theWorld.getBlockState(pos).getBlock().getRegistryName().equals("minecraft:chest") ||
			Minecraft.getMinecraft().theWorld.getBlockState(pos).getBlock().getRegistryName().equals("minecraft:stained_glass") ||
			Minecraft.getMinecraft().theWorld.getBlockState(pos).getBlock().getRegistryName().equals("minecraft:stained_glass_pane") ||
			Minecraft.getMinecraft().theWorld.getBlockState(pos).getBlock().getRegistryName().equals("minecraft:wool") ||
			Minecraft.getMinecraft().theWorld.getBlockState(pos).getBlock().getRegistryName().equals("minecraft:stained_hardened_clay");
	}
