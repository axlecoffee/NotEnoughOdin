...
public class GuiItemCustomize extends GuiScreen {
	...
	public void handleMouseInput() throws IOException {
		int mouseX = Mouse.getEventX() * this.width / Minecraft.getMinecraft().displayWidth;
		int mouseY = this.height - Mouse.getEventY() * this.height / Minecraft.getMinecraft().displayHeight - 1;
