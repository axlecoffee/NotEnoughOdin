...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.dungeon.LeapMenu
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.dungeon.LeapMenu.odinSorting
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.dungeon.MapInfo.shownTitle
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.dungeon.Mimic
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.equalsOneOf
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.hasBonusPaulScore
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.noControlCodes
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.romanToInt
...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.utils.skyblock.dungeon.DungeonUtils.getDungeonTeammates
...
class Dungeon {
        ...
        when (event.packet) {
            ...
            is S02PacketChat -> {
                ...
                deathRegex.find(message)?.let { match ->
                    dungeonTeammates.find { teammate -> teammate.name == (match.groupValues[1].takeUnless { it == "You" } ?: Minecraft.getMinecraft().thePlayer?.name) }?.deaths?.inc()
                }
    ...
    private fun updateDungeonTeammates(tabList: List<String>) {
        ...
        dungeonTeammatesNoSelf = dungeonTeammates.filter { it.entity != Minecraft.getMinecraft().thePlayer }
