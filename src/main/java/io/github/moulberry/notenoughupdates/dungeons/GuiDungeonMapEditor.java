...
public class GuiDungeonMapEditor extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		mouseX = Mouse.getEventX() * this.width / Minecraft.getMinecraft().displayWidth;
		mouseY = this.height - Mouse.getEventY() * this.height / Minecraft.getMinecraft().displayHeight - 1;
	...
	public void handleMouseInput() throws IOException {
		...
		if (activeColourEditor != null) {
			...
			int mouseX = Mouse.getEventX() * realRes.getScaledWidth() / Minecraft.getMinecraft().displayWidth;
			int mouseY =
