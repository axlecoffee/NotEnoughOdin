...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.floor7.DragonCheck.dragonEntityList
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.floor7.DragonCheck.lastDragonDeath
...
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.floor7.WitherDragons.sendArrowHit
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.floor7.WitherDragons.sendSpawned
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.floor7.WitherDragons.sendSpawning
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.floor7.WitherDragons.sendTime
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.skyblock.ArrowHit.onDragonSpawn
import io.github.moulberry.notenoughupdates.odinclient.odinmain.features.impl.skyblock.ArrowHit.resetOnDragons
...
enum class WitherDragonsEnum (
    ...
    fun updateEntity(entityId: Int) {
        entity = (Minecraft.getMinecraft().theWorld.getEntityByID(entityId) as? EntityDragon)?.also { dragonEntityList.add(it) } ?: return
    }
