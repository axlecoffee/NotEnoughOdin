...
object EtherWarpHelper {
    ...
    fun getEtherPos(pos: Vec3, yaw: Float, pitch: Float, distance: Double = 60.0, returnEnd: Boolean = false): EtherPos {
        Minecraft.getMinecraft().thePlayer ?: return EtherPos.NONE
    ...
    fun getEtherPos(positionLook: PositionLook = PositionLook(Minecraft.getMinecraft().thePlayer.renderVec, Minecraft.getMinecraft().thePlayer.rotationYaw, Minecraft.getMinecraft().thePlayer.rotationPitch), distance: Double =  56.0 + Minecraft.getMinecraft().thePlayer.heldItem.getTunerBonus): EtherPos {
    ...
    private fun traverseVoxels(start: Vec3, end: Vec3): EtherPos {
        ...
        repeat(1000) {
            val chunk = Minecraft.getMinecraft().theWorld?.chunkProvider?.provideChunk(x.toInt() shr 4, z.toInt() shr 4) ?: return EtherPos.NONE
